...
```html
<script src="https://cdn.auth0.com/js/auth0-spa-js/1.7.0/auth0-spa-js.production.js"></script>
```
...
**Note** This configuration option requires Rotating Refresh Tokens to be enabled for your Auth0 Tenant. If this setting is not enabled, specifying `useRefreshTokens: true` here will cause an error at runtime.
